    ...
    <>
      ...
      <section className="hero">
        <div className="container">
          ...
          <h1>Cansado de Voltar do Passeio com o Braço Doendo?</h1>

          <img src="/capas/pagina3/hero.webp" alt="Mockup Guia O Passeio Perfeito" className="hero-mockup" />
          
          <p className="hero-subheadline">O método definitivo para ensinar seu cachorro a andar sem puxar a guia, focado em você e sem reatividade. Um passeio tranquilo para ambos.</p>
        ...
        <section className="transformation-section reveal active">
          ...
          <div className="transformation-grid">
            <div className="step-card">
              ...
              <h3>Equipamento Certo</h3>
              <p>Descubra por que a maioria dos peitorais estimula o cão a puxar ainda mais, e qual usar.</p>
            </div>
            <div className="step-card">
              <div className="step-number">2</div>
              <div className="step-icon">👀</div>
              <h3>Foco no Tutor</h3>
              <p>O segredo para fazer o cachorro prestar atenção em você mesmo na rua cheia de distrações.</p>
            </div>
            <div className="step-card">
              <div className="step-number">3</div>
              <div className="step-icon">🥩</div>
              <h3>Recompensa de Proximidade</h3>
              <p>Como recompensar a guia frouxa para que ele prefira andar do seu lado.</p>
            </div>
          </div>
        </section>
        ...
        <section className="features-section reveal active">
          ...
          <div className="feature-card">
            <div className="feature-card-header">
              ...
              <h3>Módulo 1: Preparação Pré-Passeio</h3>
            </div>
            <ul className="feature-bullets">
              <li>Como gastar energia física e mental antes de sair.</li>
              <li>A diferença entre coleira, peitoral anti-puxão e enforcador.</li>
              <li>Exercícios de controle de impulso na porta de casa.</li>
            </ul>
          </div>
          ...
          <div className="feature-card">
            <div className="feature-card-header">
              ...
              <h3>Módulo 2: O Passo a Passo da Guia Frouxa</h3>
            </div>
            <ul className="feature-bullets">
              <li>Técnica do "Puxou, Parou" e como aplicá-la.</li>
              <li>Como ensinar o comando "Junto" desde o início.</li>
              <li>Recompensando a atenção espontânea durante a caminhada.</li>
            </ul>
          </div>
          ...
          <div className="feature-card">
            <div className="feature-card-header">
              ...
              <h3>Módulo 3: Lidando com Reatividade</h3>
            </div>
            <ul className="feature-bullets">
              <li>O que fazer quando ele avista outro cachorro e surta.</li>
              <li>Lidando com latidos para motos, bicicletas e pessoas.</li>
              <li>Construindo confiança em cães medrosos na rua.</li>
            </ul>
          </div>
        </section>
            ...
            <div className="prova-container-wrapper marquee-wrapper" id="reviewWrapper" ref={reviewTrackRef}>
              <div className="marquee-track" id="reviewTrack">
                ...
                <div className="prova-card-html">
                  ...
                  <p className="quote">"Eu já não aguentava mais voltar pra casa com o braço doendo de tanto que a Belinha puxava. Em apenas 5 dias aplicando a técnica de mudança de direção, os passeios viraram um momento de paz!"</p>
                ...
                <div className="prova-card-html">
                  <div className="stars">⭐⭐⭐⭐⭐</div>
                  <p className="quote">"Sempre achei que enforcador era o certo. Esse guia me mostrou que eu estava criando trauma no Max e o deixando mais reativo. Comprei o peitoral certo, mudei a tática e ele aprendeu a andar do meu lado."</p>
                  <div className="author-info">
                ...
                <div className="prova-card-html">
                  <div className="stars">⭐⭐⭐⭐⭐</div>
                  <p className="quote">"O melhor investimento que fiz! Finalmente posso passear no parque sem que o Thor faça um escândalo puxando pra cima de outros cães. Gratidão!"</p>
                  <div className="author-info">
          ...
          <div className="bonus-container">
            ...
            <div className="bonus-grid">
              ...
              <div className="bonus-card">
                <img src="/capas/pagina3/silencio.webp" alt="Bonus 1" className="bonus-img" />
                <div className="bonus-card-content">
                  <h3>🎁 Bônus #1: Guia Silêncio em Casa</h3>
              ...
              <div className="bonus-card">
                <img src="/capas/pagina2/xixi-e-coco.webp" alt="Bonus 2" className="bonus-img" />
                <div className="bonus-card-content">
                  <h3>🎁 Bônus #2: O Fim da Sujeira (Xixi e Cocô)</h3>
                  <p className="bonus-price">Valor: <span>R$ 27,90</span> | Hoje: <strong>GRÁTIS</strong></p>
                  <ul className="bonus-list">
                    <li>Ensine a usar o tapete higiênico sem erro.</li>
                    <li>Remova odores e evite marcação de território.</li>
                  </ul>
                </div>
              </div>
        ...
        <section className="pricing-section reveal active" id="planos">
          ...
          <div className="pricing-grid">
            ...
            <div className="plan-card">
              <img src="/capas/pagina3/basico-16-9.webp" alt="Guia O Passeio Perfeito" className="plan-img-16x9" />
              <div className="plan-card-body">
                <div className="plan-name">Guia O Passeio Perfeito</div>
                <div className="plan-price"><sup>R$</sup>17,90</div>
                <p className="plan-installments">Pagamento único</p>
                <ul className="plan-features">
                  <li>O Guia Principal "O Passeio Perfeito"</li>
                  <li>Método passo a passo de guia frouxa</li>
                  <li className="denied">Sem o Guia de Latidos</li>
                  <li className="denied">Sem o Guia de Xixi e Cocô</li>
                  <li className="denied">Sem o Dicionário Canino</li>
                  <li className="denied">Sem os Bônus Premium de hoje</li>
                </ul>
                <a href="https://pay.cakto.com.br/eucg5oz_984057" className="plan-cta basic" id="btnStarter">QUERO APENAS O BÁSICO</a>
              </div>
            </div>

            {/* Ultimate Pack */}
            <div className="plan-card featured">
              <img src="/capas/pagina3/completo-16-9.webp" alt="Guia do Adestramento Completo" className="plan-img-16x9" />
              <div className="plan-card-body">
                ...
                <ul className="plan-features">
                  <li><strong>Guia: O Passeio Perfeito - <span style={{color: '#d4af37', fontWeight: 'bold'}}>PREMIUM</span></strong></li>
                  <li><strong>Guia: Silêncio em Casa</strong></li>
                  <li><strong>Guia: O Fim da Sujeira (Xixi e Cocô)</strong></li>
      ...
      {showDownsell && (
        <div className="downsell-overlay" style={{display: "flex"}}>
          <div className="downsell-box">
            ...
            <a href="https://pay.cakto.com.br/eucg5oz_984057" className="downsell-skip-link">Não, obrigado. Eu quero apenas o plano básico por R$ 17,90.</a>
          </div>
        </div>
      )}
