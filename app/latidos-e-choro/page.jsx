        ...
        <section className="features-section reveal active">
          ...
          <div className="feature-card">
            <div className="feature-card-header">
              ...
              <h3>Módulo 1: O Gatilho do Latido</h3>
            </div>
            <ul className="feature-bullets">
              <li>Entendendo a real motivação por trás do latido.</li>
              <li>Por que gritar com ele só piora a situação.</li>
              <li>A linguagem corporal canina antes do barulho.</li>
            </ul>
          </div>
          ...
          <div className="feature-card">
            <div className="feature-card-header">
              ...
              <h3>Módulo 2: O Desmame da Atenção</h3>
            </div>
            <ul className="feature-bullets">
              <li>O passo a passo para curar a ansiedade de separação.</li>
              <li>Exercícios de independência na rotina diária.</li>
              <li>Como sair e voltar para casa sem gerar ansiedade.</li>
            </ul>
          </div>
          ...
          <div className="feature-card">
            <div className="feature-card-header">
              ...
              <h3>Módulo 3: Silêncio e Visitas</h3>
            </div>
            <ul className="feature-bullets">
              <li>Como dessensibilizar o som da campainha ou interfone.</li>
              <li>O que fazer quando a visita entra na casa.</li>
              <li>Lidando com barulhos da rua e de outros cães.</li>
            </ul>
          </div>
        </section>
            ...
            <div className="prova-container-wrapper marquee-wrapper" id="reviewWrapper" ref={reviewTrackRef}>
              <div className="marquee-track" id="reviewTrack">
                ...
                <div className="prova-card-html">
                  ...
                  <p className="quote">"Eu já não aguentava mais as reclamações dos vizinhos no condomínio. Em apenas 5 dias a Belinha entendeu que ficar sozinha não é ruim e parou de chorar na porta!"</p>
                ...
                <div className="prova-card-html">
                  <div className="stars">⭐⭐⭐⭐⭐</div>
                  <p className="quote">"Sempre achei que gritar para ele parar era o certo. O guia me mostrou o erro e ensinou a técnica certa de reforço positivo. A paz reinou na minha casa."</p>
                  <div className="author-info">
                ...
                <div className="prova-card-html">
                  <div className="stars">⭐⭐⭐⭐⭐</div>
                  <p className="quote">"O melhor investimento que fiz! Finalmente posso receber minhas visitas sem que o Thor faça um escândalo e fique pulando em todo mundo. Gratidão!"</p>
                  <div className="author-info">
          ...
          <div className="bonus-container">
            ...
            <div className="bonus-grid">
              ...
              <div className="bonus-card">
                <img src="/capas/pagina2/xixi-e-coco.webp" alt="Bonus 1" className="bonus-img" />
                <div className="bonus-card-content">
                  <h3>🎁 Bônus #1: O Fim da Sujeira (Xixi e Cocô)</h3>
        ...
        <section className="pricing-section reveal active" id="planos">
          ...
          <div className="pricing-grid">
            ...
            <div className="plan-card">
              <img src="/capas/pagina2/basico-16-9.webp" alt="Guia Silêncio e Calma" className="plan-img-16x9" />
              <div className="plan-card-body">
                <div className="plan-name">Guia Silêncio e Calma</div>
                <div className="plan-price"><sup>R$</sup>17,90</div>
                <p className="plan-installments">Pagamento único</p>
                <ul className="plan-features">
                  <li>O Guia Principal "Silêncio e Calma"</li>
                  <li>Método prático para latidos e ansiedade</li>
                  <li className="denied">Sem o Guia do Xixi e Cocô</li>
                ...
                <a href="https://pay.cakto.com.br/oqd4c96_984051" className="plan-cta basic" id="btnStarter">QUERO APENAS O BÁSICO</a>
              </div>
            </div>

            {/* Ultimate Pack */}
            <div className="plan-card featured">
              <img src="/capas/pagina2/completo-16-9.webp" alt="Guia do Adestramento Completo" className="plan-img-16x9" />
              <div className="plan-card-body">
                ...
                <ul className="plan-features">
                  <li><strong>Guia: Silêncio em Casa - <span style={{color: '#d4af37', fontWeight: 'bold'}}>PREMIUM</span></strong></li>
      ...
      {showDownsell && (
        <div className="downsell-overlay" style={{display: "flex"}}>
          <div className="downsell-box">
            ...
            <a href="https://pay.cakto.com.br/oqd4c96_984051" className="downsell-skip-link">Não, obrigado. Eu quero apenas o plano básico por R$ 17,90.</a>
          </div>
        </div>
      )}
